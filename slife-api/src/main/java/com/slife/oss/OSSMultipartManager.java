package com.slife.oss;

import com.aliyun.oss.OSSClient;
import com.aliyun.oss.model.ObjectMetadata;
import com.aliyun.oss.model.PutObjectResult;
import com.slife.utils.MD5Tool;
...
public class OSSMultipartManager {
    ...
    public String uploadImages(File uploadFile) throws Exception{
        String fileName;
        InputStream inputStream = new FileInputStream(uploadFile);
//        InputStream inputStream=uploadFile..getInputStream();
        String remoteFileName = getObjectName(uploadFile.getName());
        fileName = uploadSmallFile(inputStream, uploadFile.length(), remoteFileName);
        return fileName ;
    }


    //小于5M的文件专用上传
    public String uploadSmallFile(InputStream inputStream, long fileSize, String remoteFileName) throws Exception{
    ...
    public String getObjectName(String fileName) {
        ...
        String str = MD5Tool.MD5(name+calendar) + suffix;
        return str;
    }
}
